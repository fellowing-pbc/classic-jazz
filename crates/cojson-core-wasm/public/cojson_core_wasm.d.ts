...
export class NodeCore {
  ...
  groupRemoveMember(input_json: string): string;
  /**
  ...
  groupRotateReadKey(input_json: string): string;
  /**
   ...
   */
  mapMaterializeBatch(input_json: string): string;
  /**
  ...
  groupAddMemberInternal(input_json: string): string;
  /**
  ...
  groupAddEveryoneWriteOnly(input_json: string): string;
  /**
...
export interface InitOutput {
  ...
  readonly nodecore_mapMaterializeBatch: (a: number, b: number, c: number) => [number, number, number, number];
